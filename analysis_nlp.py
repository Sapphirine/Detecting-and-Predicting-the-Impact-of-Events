...
sql_stmt = 'select tickdate, value from import_raw_ticks where tickdate between \'2012-11-01\' and \'2012-11-30\' and security = \'S5OILG Index\' and field = \'VOLUME\' order by tickdate'
if True:
  conn = psycopg2.connect(database="postgres", user = "postgres", password = "swapnil", host = "35.190.146.57", port = "5432")
  cur = conn.cursor()
...
ax1.set_xlabel('S5OILG Index (GICS Industry) References Vs Tick Volume')
